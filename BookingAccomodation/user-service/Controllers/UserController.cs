...
namespace user_service.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public UserController(UserService userService, IMapper mapper, IOptions<AppSettings> appSettings, CheckRemovalEligibility checkRemovalEligibility, GradeService gradeService)
        {
